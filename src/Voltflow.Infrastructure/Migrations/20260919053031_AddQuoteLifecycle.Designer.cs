...
namespace Voltflow.Infrastructure.Migrations
{
    ...
    [Migration("20260919053031_AddQuoteLifecycle")]
    partial class AddQuoteLifecycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voltflow.Domain.Auditing.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Voltflow.Domain.Common.DocumentCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Voltflow.Domain.Inventory.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Voltflow.Domain.Sales.CashShift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CashierUserId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashShifts_OneOpenPerCashier")
            ...
            modelBuilder.Entity("Voltflow.Domain.Sales.QuickSaleLine", b =>
                {
                    ...
                    b.Property<decimal>("ReceiptDiscountShare")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Voltflow.Domain.Sales.QuickSaleReturnLine", b =>
                {
                    ...
                    b.Property<Guid>("QuickSaleLineId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("QuickSaleReturnId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Voltflow.Domain.Sales.QuickSale", b =>
                {
                    ...
                    b.HasOne("Voltflow.Domain.Sales.CashShift", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Voltflow.Domain.Sales.QuickSaleLine", b =>
                {
                    b.HasOne("Voltflow.Domain.Inventory.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Voltflow.Domain.Sales.QuickSale", null)
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Voltflow.Domain.Sales.QuickSaleReturnLine", b =>
                {
                    b.HasOne("Voltflow.Domain.Sales.QuickSaleLine", null)
                        .WithMany()
                        .HasForeignKey("QuickSaleLineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Voltflow.Domain.Sales.QuickSaleReturn", null)
                        .WithMany("Lines")
                        .HasForeignKey("QuickSaleReturnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
