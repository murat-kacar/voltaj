...
public interface IReminderRepository
{
    ...
    Task<ReminderRecord?> GetByIdAsync(Guid id, CancellationToken ct = default);
    Task<PagedResult<ReminderRecord>> ListAsync(ReminderState? state, int limit, int offset, CancellationToken ct = default);
