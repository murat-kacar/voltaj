...
export function FormDialog({ title, submitLabel, canSubmit = true, color = 'primary', maxWidth = 'xs', onClose, onSubmit, children }: Props) {
  ...
  const handleKeyDown = (event: KeyboardEvent) => {
    ...
    if (event.key === 'Enter' && target instanceof HTMLInputElement && target.getAttribute('role') !== 'combobox') {
  ...
  return (
    <Dialog open onClose={busy ? undefined : onClose} maxWidth={maxWidth} fullWidth>
